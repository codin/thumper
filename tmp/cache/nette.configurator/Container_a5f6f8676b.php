...
class Container_a5f6f8676b extends _PHPStan_c862bb974\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService027(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a5f6f8676b $container)
			{
	...
	{
		return new PHPStan\Rules\MissingTypehintCheck($this->getService('reflectionProvider'), false, true, false, []);
	}
	...
	public function createServiceContainer(): Container_a5f6f8676b
	{
		return $this;
	}
