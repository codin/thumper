<?php
// source: phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon
// source: /home/kieron/Projects/thumper/phpstan.neon
// source: array
...
class Container_b0532d912a extends _PHPStan_c862bb974\Nette\DI\Container
{
	protected $tags = [
		'phpstan.broker.methodsClassReflectionExtension' => ['066' => true, '070' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['067' => true, '071' => true, '0171' => true],
		...
		'phpstan.broker.dynamicStaticMethodReturnTypeExtension' => ['0143' => true, '0145' => true, '0233' => true],
		...
		'phpstan.dynamicFunctionThrowTypeExtension' => ['0165' => true, '0166' => true],
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0180' => true],
		'phpstan.rules.rule' => [
			'0243' => true,
			'0244' => true,
			'0245' => true,
	...
	protected $types = ['container' => '_PHPStan_c862bb974\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_c862bb974\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'086',
				'087',
		...
		'PHPStan\Rules\Classes\ExistingClassesInClassImplementsRule' => [['rules.18']],
		'PHPStan\Rules\Classes\ExistingClassesInInterfaceExtendsRule' => [['rules.19']],
		'PHPStan\Rules\Classes\ExistingClassInTraitUseRule' => [['rules.20']],
		'PHPStan\Rules\Classes\InstantiationRule' => [['rules.21']],
		'PHPStan\Rules\Classes\InstantiationCallableRule' => [['rules.22']],
		'PHPStan\Rules\Classes\InvalidPromotedPropertiesRule' => [['rules.23']],
		'PHPStan\Rules\Classes\NewStaticRule' => [['rules.24']],
		'PHPStan\Rules\Classes\NonClassAttributeClassRule' => [['rules.25']],
		'PHPStan\Rules\Classes\TraitAttributeClassRule' => [['rules.26']],
		'PHPStan\Rules\Constants\FinalConstantRule' => [['rules.27']],
		'PHPStan\Rules\Exceptions\ThrowExpressionRule' => [['rules.28']],
		'PHPStan\Rules\Functions\ArrowFunctionAttributesRule' => [['rules.29']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule' => [['rules.30']],
		'PHPStan\Rules\Functions\CallToFunctionParametersRule' => [['rules.31']],
		'PHPStan\Rules\Functions\ClosureAttributesRule' => [['rules.32']],
		'PHPStan\Rules\Functions\DefineParametersRule' => [['rules.33']],
		'PHPStan\Rules\Functions\ExistingClassesInArrowFunctionTypehintsRule' => [['rules.34']],
		'PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule' => [['rules.35']],
		'PHPStan\Rules\Functions\ExistingClassesInTypehintsRule' => [['rules.36']],
		'PHPStan\Rules\Functions\FunctionAttributesRule' => [['rules.37']],
		'PHPStan\Rules\Functions\InnerFunctionRule' => [['rules.38']],
		'PHPStan\Rules\Functions\ParamAttributesRule' => [['rules.39']],
		'PHPStan\Rules\Functions\PrintfParametersRule' => [['rules.40']],
		'PHPStan\Rules\Functions\ReturnNullsafeByRefRule' => [['rules.41']],
		'PHPStan\Rules\Keywords\ContinueBreakInLoopRule' => [['rules.42']],
		'PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule' => [['rules.43']],
		'PHPStan\Rules\Methods\CallMethodsRule' => [['rules.44']],
		'PHPStan\Rules\Methods\CallStaticMethodsRule' => [['rules.45']],
		'PHPStan\Rules\Methods\ExistingClassesInTypehintsRule' => [['rules.46']],
		'PHPStan\Rules\Methods\MethodCallableRule' => [['rules.47']],
		'PHPStan\Rules\Methods\MissingMethodImplementationRule' => [['rules.48']],
		'PHPStan\Rules\Methods\MethodAttributesRule' => [['rules.49']],
		'PHPStan\Rules\Methods\StaticMethodCallableRule' => [['rules.50']],
		'PHPStan\Rules\Operators\InvalidAssignVarRule' => [['rules.51']],
		'PHPStan\Rules\Properties\AccessPropertiesInAssignRule' => [['rules.52']],
		'PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule' => [['rules.53']],
		'PHPStan\Rules\Properties\PropertyAttributesRule' => [['rules.54']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyRule' => [['rules.55']],
		'PHPStan\Rules\Variables\UnsetRule' => [['rules.56']],
		'PHPStan\Rules\Whitespace\FileWhitespaceRule' => [['rules.57']],
		'PHPStan\Rules\Classes\UnusedConstructorParametersRule' => [['rules.58']],
		'PHPStan\Rules\Constants\ConstantRule' => [['rules.59']],
		'PHPStan\Rules\Functions\UnusedClosureUsesRule' => [['rules.60']],
		'PHPStan\Rules\Variables\EmptyRule' => [['rules.61']],
		'PHPStan\Rules\Variables\IssetRule' => [['rules.62']],
		'PHPStan\Rules\Variables\NullCoalesceRule' => [['rules.63']],
		'PHPStan\Rules\Cast\EchoRule' => [['rules.64']],
		'PHPStan\Rules\Cast\InvalidCastRule' => [['rules.65']],
		'PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule' => [['rules.66']],
		'PHPStan\Rules\Cast\PrintRule' => [['rules.67']],
		'PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule' => [['rules.68']],
		'PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule' => [['rules.69']],
		'PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule' => [['rules.70']],
		'PHPStan\Rules\Generics\ClassTemplateTypeRule' => [['rules.71']],
		'PHPStan\Rules\Generics\FunctionTemplateTypeRule' => [['rules.72']],
		'PHPStan\Rules\Generics\FunctionSignatureVarianceRule' => [['rules.73']],
		'PHPStan\Rules\Generics\InterfaceTemplateTypeRule' => [['rules.74']],
		'PHPStan\Rules\Generics\MethodTemplateTypeRule' => [['rules.75']],
		'PHPStan\Rules\Generics\MethodSignatureVarianceRule' => [['rules.76']],
		'PHPStan\Rules\Generics\TraitTemplateTypeRule' => [['rules.77']],
		'PHPStan\Rules\Generics\UsedTraitsRule' => [['rules.78']],
		'PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule' => [['rules.79']],
		'PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule' => [['rules.80']],
		'PHPStan\Rules\Operators\InvalidBinaryOperationRule' => [['rules.81']],
		'PHPStan\Rules\Operators\InvalidUnaryOperationRule' => [['rules.82']],
		'PHPStan\Rules\Operators\InvalidComparisonOperationRule' => [['rules.83']],
		'PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule' => [['rules.84']],
		'PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule' => [['rules.85']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule' => [['rules.86']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [['rules.87']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [['rules.88']],
		'PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule' => [['rules.89']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['rules.90']],
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['rules.91']],
		'PHPStan\Rules\Arrays\AppendedArrayItemTypeRule' => [['rules.92']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['rules.93']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [['rules.94']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [['rules.95']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [['rules.96']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [['rules.97']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [['rules.98']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [['rules.99']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [['rules.100']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [['rules.101']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [['rules.102']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [['rules.103']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [['rules.104']],
		'PHPStan\Rules\Variables\ThrowTypeRule' => [['rules.105']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [['rules.106']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [['rules.107']],
		'PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule' => [['rules.108']],
		'PHPStan\Rules\DeadCode\NoopRule' => [['rules.109']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [['rules.110']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['rules.111']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['rules.112']],
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['rules.113']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['rules.114']],
		'PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule' => [['rules.115']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [['rules.116']],
		'PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule' => [['rules.117']],
		'PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule' => [['rules.118']],
		'PHPStan\Rules\Methods\NullsafeMethodCallRule' => [['rules.119']],
		'PHPStan\Rules\Properties\NullsafePropertyFetchRule' => [['rules.120']],
		'PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule' => [['rules.121']],
		'PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule' => [['rules.122']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule' => [['rules.123']],
		'PHPStan\Rules\DateTimeInstantiationRule' => [['rules.124']],
		'PHPStan\Rules\Functions\ImplodeFunctionRule' => [['rules.125']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.126']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.127']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.128']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.129']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.130']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.131']],
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['056', '067', '068', '071', '0171']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0143', '0145', '0233']],
		'PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension' => [['0143']],
		'PHPStan\Type\DynamicMethodReturnTypeExtension' => [
			['0144', '0154', '0173', '0226', '0227', '0233', '0234', '0235', '0236', '0237', '0238'],
		],
		...
		'PHPStan\Type\DynamicStaticMethodThrowTypeExtension' => [['0151', '0153', '0167', '0168', '0169', '0170', '0172']],
		...
		'PHPStan\Type\Php\GetoptFunctionDynamicReturnTypeExtension' => [['0160']],
		...
		'PHPStan\Type\Php\HashHmacFunctionsReturnTypeExtension' => [['0163']],
		'PHPStan\Type\Php\HashFunctionsReturnTypeExtension' => [['0164']],
		'PHPStan\Type\DynamicFunctionThrowTypeExtension' => [['0165', '0166']],
		'PHPStan\Type\Php\IntdivThrowTypeExtension' => [['0165']],
		'PHPStan\Type\Php\JsonThrowTypeExtension' => [['0166']],
		'PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension' => [['0167']],
		'PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension' => [['0168']],
		'PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension' => [['0169']],
		'PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension' => [['0170']],
		'PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension' => [['0171']],
		'PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension' => [['0172']],
		'PHPStan\Type\Php\StatDynamicReturnTypeExtension' => [['0173']],
		'PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension' => [['0174']],
		'PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension' => [['0175']],
		'PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension' => [['0176']],
		'PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension' => [['0177']],
		'PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension' => [['0178']],
		'PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension' => [['0179']],
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0180']],
		'PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension' => [['0180']],
		'PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension' => [['0181']],
		'PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension' => [['0182']],
		'PHPStan\Type\Php\VarExportFunctionDynamicReturnTypeExtension' => [['0183']],
		'PHPStan\Type\Php\MbFunctionsReturnTypeExtension' => [['0184']],
		'PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension' => [['0185']],
		'PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension' => [['0186']],
		'PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension' => [['0187']],
		'PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension' => [['0188']],
		'PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension' => [['0189']],
		'PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension' => [['0190']],
		'PHPStan\Type\Php\StrlenFunctionReturnTypeExtension' => [['0191']],
		'PHPStan\Type\Php\StrPadFunctionReturnTypeExtension' => [['0192']],
		'PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension' => [['0193']],
		'PHPStan\Type\Php\SubstrDynamicReturnTypeExtension' => [['0194']],
		'PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension' => [['0195']],
		'PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension' => [['0196']],
		'PHPStan\Type\Php\PowFunctionReturnTypeExtension' => [['0197']],
		'PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension' => [['0198']],
		'PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension' => [['0199']],
		'PHPStan\Type\Php\RangeFunctionReturnTypeExtension' => [['0200']],
		'PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension' => [['0201']],
		'PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension' => [['0202']],
		'PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension' => [['0203']],
		'PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension' => [['0204']],
		'PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension' => [['0205']],
		'PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension' => [['0206']],
		'PHPStan\Type\Php\IsIntFunctionTypeSpecifyingExtension' => [['0207']],
		'PHPStan\Type\Php\IsFloatFunctionTypeSpecifyingExtension' => [['0208']],
		'PHPStan\Type\Php\IsNullFunctionTypeSpecifyingExtension' => [['0209']],
		'PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension' => [['0210']],
		'PHPStan\Type\Php\IsBoolFunctionTypeSpecifyingExtension' => [['0211']],
		'PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension' => [['0212']],
		'PHPStan\Type\Php\IsCountableFunctionTypeSpecifyingExtension' => [['0213']],
		'PHPStan\Type\Php\IsResourceFunctionTypeSpecifyingExtension' => [['0214']],
		'PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension' => [['0215']],
		'PHPStan\Type\Php\IsStringFunctionTypeSpecifyingExtension' => [['0216']],
		'PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension' => [['0217']],
		'PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension' => [['0218']],
		'PHPStan\Type\Php\IsObjectFunctionTypeSpecifyingExtension' => [['0219']],
		'PHPStan\Type\Php\IsNumericFunctionTypeSpecifyingExtension' => [['0220']],
		'PHPStan\Type\Php\IsScalarFunctionTypeSpecifyingExtension' => [['0221']],
		'PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension' => [['0222']],
		'PHPStan\Type\Php\ArrayIsListFunctionTypeSpecifyingExtension' => [['0223']],
		'PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension' => [['0224']],
		'PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension' => [['0225']],
		'PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension' => [['0226']],
		'PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension' => [['0227']],
		'PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension' => [['0228']],
		'PHPStan\Type\Php\StrTokFunctionReturnTypeExtension' => [['0229']],
		'PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension' => [['0230']],
		'PHPStan\Type\Php\StrvalFamilyFunctionReturnTypeExtension' => [['0231']],
		'PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension' => [['0232']],
		'PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension' => [['0233']],
		'PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension' => [['0234', '0235', '0236', '0237', '0238']],
		...
		'PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory' => [['0239']],
		'PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory' => [['0240']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\SourceStubber' => [1 => ['0241', '0242']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber' => [['0241']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber' => [['0242']],
		...
		'PHPStan\Rules\Classes\ExistingClassInClassExtendsRule' => [['0243']],
		'PHPStan\Rules\Classes\ExistingClassInInstanceOfRule' => [['0244']],
		'PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule' => [['0245']],
		'PHPStan\Rules\Functions\CallToNonExistentFunctionRule' => [['0246']],
		'PHPStan\Rules\Constants\OverridingConstantRule' => [['0247']],
		'PHPStan\Rules\Methods\OverridingMethodRule' => [['0248']],
		'PHPStan\Rules\Missing\MissingReturnRule' => [['0249']],
		'PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule' => [['0250']],
		'PHPStan\Rules\Namespaces\ExistingNamesInUseRule' => [['0251']],
		'PHPStan\Rules\Operators\InvalidIncDecOperationRule' => [['0252']],
		'PHPStan\Rules\Properties\AccessPropertiesRule' => [['0253']],
		'PHPStan\Rules\Properties\AccessStaticPropertiesRule' => [['0254']],
		'PHPStan\Rules\Properties\ExistingClassesInPropertiesRule' => [['0255']],
		'PHPStan\Rules\Functions\FunctionCallableRule' => [['0256']],
		'PHPStan\Rules\Properties\OverridingPropertyRule' => [['0257']],
		'PHPStan\Rules\Properties\UninitializedPropertyRule' => [['0258']],
		'PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule' => [['0259']],
		'PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule' => [['0260']],
		'PHPStan\Rules\Variables\CompactVariablesRule' => [['0261']],
		'PHPStan\Rules\Variables\DefinedVariableRule' => [['0262']],
		'PHPStan\Rules\Regexp\RegularExpressionPatternRule' => [['0263']],
		'PHPStan\Rules\Classes\LocalTypeAliasesRule' => [['0264']],
		'PHPStan\Rules\Classes\MixinRule' => [['0265']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0266']],
		'PHPStan\Rules\Generics\ClassAncestorsRule' => [['0267']],
		'PHPStan\Rules\Generics\InterfaceAncestorsRule' => [['0268']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0269']],
		'PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule' => [['0270']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0271']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0272']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0273']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0274']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0275']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['0276']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0277']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0278']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0279']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0280']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0281']],
		'PHPStan\Rules\Comparison\BooleanNotConstantConditionRule' => [['0282']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0283']],
		'PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule' => [['0284']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0285']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0286']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0287']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0288']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0289']],
		'PHPStan\Rules\Comparison\MatchExpressionRule' => [['0290']],
		'PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule' => [['0291']],
		'PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule' => [['0292']],
		'PHPStan\Rules\Comparison\UnreachableIfBranchesRule' => [['0293']],
		'PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule' => [['0294']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule' => [['0295']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule' => [['0296']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule' => [['0297']],
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0298']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'stubFiles' => [
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
			],
			'bootstrapFiles' => [
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
				'/home/kieron/Projects/thumper/vendor/autoload.php',
			],
			'excludes_analyse' => [],
			'excludePaths' => null,
			'level' => 'max',
			'paths' => ['/home/kieron/Projects/thumper/src'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'memoryLimitFile' => '/home/kieron/Projects/thumper/tmp/.memory_limit',
			'tempResultCachePath' => '/home/kieron/Projects/thumper/tmp/resultCaches',
			'resultCachePath' => '/home/kieron/Projects/thumper/tmp/resultCache.php',
			...
			'tmpDir' => '/home/kieron/Projects/thumper/tmp',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/home/kieron/Projects/thumper/tmp',
			'rootDir' => '/home/kieron/Projects/thumper/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/home/kieron/Projects/thumper',
			'cliArgumentsVariablesRegistered' => true,
			'additionalConfigFiles' => [
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/kieron/Projects/thumper/phpstan.neon',
			],
			'composerAutoloaderProjectPaths' => [
				'/home/kieron/Projects/thumper/vendor/phpstan/phpstan/..',
				'/home/kieron/Projects/thumper',
			],
			'generateBaselineFile' => '/home/kieron/Projects/thumper/phpstan-baseline.neon',
			'usedLevel' => 'max',
			...
			'__parametersSchema' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
				"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
					'bootstrapFiles' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00merge" => true,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00required" => true,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00default" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00before" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00asserts" => [],
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00castTo" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00deprecated" => null,
						]),
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00merge" => true,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00required" => true,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00default" => [],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00before" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00asserts" => [],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00castTo" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00deprecated" => null,
					]),
					'excludes_analyse' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'excludePaths' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\AnyOf', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00set" => [
							\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
									'analyse' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								...
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00otherItems" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00range" => [null, null],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00skipDefaults" => false,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00required" => true,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00default" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00before" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00asserts" => [],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00castTo" => 'object',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00deprecated" => null,
							]),
							\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
									'analyseAndScan' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						...
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00required" => true,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00default" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00before" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00asserts" => [],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00castTo" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00deprecated" => null,
					]),
					'level' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\AnyOf', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00set" => [
							\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
					...
					'paths' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'exceptions' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
							'implicitThrows' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
							...
							'uncheckedExceptionRegexes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							...
							'uncheckedExceptionClasses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							...
							'checkedExceptionRegexes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							...
							'checkedExceptionClasses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							...
							'check' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
									'missingCheckedExceptionInThrows' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
									...
									'tooWideThrowType' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
										"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'featureToggles' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
							'bleedingEdge' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'disableRuntimeReflectionProvider' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'skipCheckGenericClasses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'fileExtensions' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'checkAdvancedIsset' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkAlwaysTrueCheckTypeFunctionCall' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkAlwaysTrueInstanceof' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkAlwaysTrueStrictComparison' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkClassCaseSensitivity' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkExplicitMixed' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkFunctionArgumentTypes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkFunctionNameCase' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkGenericClassInNonGenericObjectType' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkInternalClassCaseSensitivity' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkMissingIterableValueType' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkMissingCallableSignature' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkMissingVarTagTypehint' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkArgumentsPassedByReference' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkMaybeUndefinedVariables' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkNullables' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkThisOnly' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkUnionTypes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkExplicitMixedMissingReturn' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkPhpDocMissingReturn' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkPhpDocMethodSignatures' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkExtraArguments' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkMissingTypehints' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkTooWideReturnTypesInProtectedAndPublicMethods' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'checkUninitializedProperties' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'inferPrivatePropertyTypeFromConstructor' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'tipsOfTheDay' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportMaybes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportMaybesInMethodSignatures' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportMaybesInPropertyPhpDocTypes' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportStaticMethodSignatures' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'parallel' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
							'jobSize' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'processTimeout' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'float',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
							...
							'maximumNumberOfProcesses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'minimumNumberOfJobsPerProcess' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'buffer' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'phpVersion' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\AnyOf', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00set" => [
							\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [70100.0, 80199.0],
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00merge" => true,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00required" => true,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00default" => null,
					...
					'polluteScopeWithLoopInitialAssignments' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'polluteScopeWithAlwaysIterableForeach' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'propertyAlwaysWrittenTags' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'propertyAlwaysReadTags' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'additionalConstructors' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'treatPhpDocTypesAsCertain' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportMagicMethods' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportMagicProperties' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'ignoreErrors' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\AnyOf', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\AnyOf\x00set" => [
								\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								...
								\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
										'message' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
										...
										'path' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
								...
								\_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
										...
										'count' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
									...
									"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
										...
										'paths' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
											...
											"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
												...
												"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
												"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
												"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [
													null,
													null,
												],
												"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
					...
					'internalErrorsCountLimit' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'cache' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Structure', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Structure\x00items" => [
							'nodesByFileCountMax' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
							...
							'nodesByStringCountMax' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'int',
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
								"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'reportUnmatchedIgnoredErrors' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'scopeClass' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'typeAliases' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'array',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
					...
					'universalObjectCratesClasses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'stubFiles' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'earlyTerminatingMethodCalls' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'array',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
					...
					'earlyTerminatingFunctionCalls' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'memoryLimitFile' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'tempResultCachePath' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'resultCachePath' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'resultCacheChecksProjectExtensionFilesDependencies' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'staticReflectionClassNamePatterns' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'dynamicConstantNames' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'customRulesetUsed' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'rootDir' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'tmpDir' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'currentWorkingDirectory' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'cliArgumentsVariablesRegistered' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'mixinExcludeClasses' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'scanFiles' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'scanDirectories' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'fixerTmpDir' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'editorUrl' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'null|string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
					...
					'debugMode' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'productionMode' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'bool',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'tempDir' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'additionalConfigFiles' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'generateBaselineFile' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'null|string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'analysedPaths' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'composerAutoloaderProjectPaths' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'analysedPathsFromConfig' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'list',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
							"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
					...
					'usedLevel' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'cliAutoloadFile' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'null|string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'singleReflectionFile' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'null|string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'singleReflectionInsteadOfFile' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => 'null|string',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
					...
					'__parametersSchema' => \_PHPStan_c862bb974\Nette\PhpGenerator\Dumper::createObject('_PHPStan_c862bb974\Nette\Schema\Elements\Type', [
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00type" => '_PHPStan_c862bb974\Nette\Schema\Schema',
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsValue" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00itemsKey" => null,
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00range" => [null, null],
						"\x00_PHPStan_c862bb974\\Nette\\Schema\\Elements\\Type\x00pattern" => null,
	...
	public function createService09(): PHPStan\Php\PhpVersionFactoryFactory
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(
			null,
			['/home/kieron/Projects/thumper/vendor/phpstan/phpstan/..', '/home/kieron/Projects/thumper']
		);
	}
	...
	{
		return new PHPStan\Analyser\IgnoredErrorHelper($this->getService('033'), $this->getService('045'), [], true);
	}
	...
	public function createService027(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b0532d912a $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/kieron/Projects/thumper/tmp/resultCache.php',
					'/home/kieron/Projects/thumper/tmp/resultCaches',
	...
	public function createService030(): PHPStan\Command\AnalyseApplication
	{
		return new PHPStan\Command\AnalyseApplication(
			...
			$this->getService('027'),
			$this->getService('024'),
			'/home/kieron/Projects/thumper/tmp/.memory_limit',
			50
		);
	}
	...
	public function createService040(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/home/kieron/Projects/thumper',
			'/home/kieron/Projects/thumper/tmp',
			[
				'phar:///home/kieron/Projects/thumper/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/kieron/Projects/thumper/phpstan.neon',
			],
			...
			'max',
			'/home/kieron/Projects/thumper/phpstan-baseline.neon',
			null,
	...
	{
		return new PHPStan\File\FileHelper('/home/kieron/Projects/thumper');
	}


	public function createService046(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory($this->getService('047'), [], null);
	}
	...
	{
		return new PHPStan\Rules\MissingTypehintCheck($this->getService('reflectionProvider'), true, true, false, []);
	}
	...
	public function createService0160(): PHPStan\Type\Php\GetoptFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0163(): PHPStan\Type\Php\HashHmacFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\HashHmacFunctionsReturnTypeExtension;
	}


	public function createService0164(): PHPStan\Type\Php\HashFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\HashFunctionsReturnTypeExtension;
	}


	public function createService0165(): PHPStan\Type\Php\IntdivThrowTypeExtension
	{
		return new PHPStan\Type\Php\IntdivThrowTypeExtension;
	}


	public function createService0166(): PHPStan\Type\Php\JsonThrowTypeExtension
	{
		return new PHPStan\Type\Php\JsonThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0167(): PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0168(): PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0169(): PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0170(): PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0171(): PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension;
	}


	public function createService0172(): PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension;
	}


	public function createService0173(): PHPStan\Type\Php\StatDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\StatDynamicReturnTypeExtension;
	}


	public function createService0174(): PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension;
	}


	public function createService0175(): PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension($this->getService('0110'));
	}


	public function createService0176(): PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension;
	}


	public function createService0177(): PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension;
	}


	public function createService0178(): PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension;
	}


	public function createService0179(): PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0180(): PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension;
	}


	public function createService0181(): PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension;
	}


	public function createService0182(): PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension;
	}


	public function createService0183(): PHPStan\Type\Php\VarExportFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\VarExportFunctionDynamicReturnTypeExtension;
	}


	public function createService0184(): PHPStan\Type\Php\MbFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbFunctionsReturnTypeExtension;
	}


	public function createService0185(): PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension;
	}


	public function createService0186(): PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension($this->getService('07'));
	}


	public function createService0187(): PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension;
	}


	public function createService0188(): PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension;
	}


	public function createService0189(): PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension;
	}


	public function createService0190(): PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension;
	}


	public function createService0191(): PHPStan\Type\Php\StrlenFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrlenFunctionReturnTypeExtension;
	}


	public function createService0192(): PHPStan\Type\Php\StrPadFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrPadFunctionReturnTypeExtension;
	}


	public function createService0193(): PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension;
	}


	public function createService0194(): PHPStan\Type\Php\SubstrDynamicReturnTypeExtension
	{
	...
	public function createService0196(): PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension;
	}


	public function createService0197(): PHPStan\Type\Php\PowFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\PowFunctionReturnTypeExtension;
	}


	public function createService0198(): PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension;
	}


	public function createService0199(): PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension;
	}


	public function createService0200(): PHPStan\Type\Php\RangeFunctionReturnTypeExtension
	{
	...
	public function createService0202(): PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0203(): PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension;
	}


	public function createService0204(): PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension;
	}


	public function createService0205(): PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0206(): PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension;
	}


	public function createService0207(): PHPStan\Type\Php\IsIntFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsIntFunctionTypeSpecifyingExtension;
	}


	public function createService0208(): PHPStan\Type\Php\IsFloatFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsFloatFunctionTypeSpecifyingExtension;
	}


	public function createService0209(): PHPStan\Type\Php\IsNullFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsNullFunctionTypeSpecifyingExtension;
	}


	public function createService0210(): PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension;
	}


	public function createService0211(): PHPStan\Type\Php\IsBoolFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsBoolFunctionTypeSpecifyingExtension;
	}


	public function createService0212(): PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension($this->getService('0174'));
	}


	public function createService0213(): PHPStan\Type\Php\IsCountableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsCountableFunctionTypeSpecifyingExtension;
	}


	public function createService0214(): PHPStan\Type\Php\IsResourceFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsResourceFunctionTypeSpecifyingExtension;
	}


	public function createService0215(): PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension;
	}


	public function createService0216(): PHPStan\Type\Php\IsStringFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsStringFunctionTypeSpecifyingExtension;
	}


	public function createService0217(): PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension;
	}


	public function createService0218(): PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension;
	}


	public function createService0219(): PHPStan\Type\Php\IsObjectFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsObjectFunctionTypeSpecifyingExtension;
	}


	public function createService0220(): PHPStan\Type\Php\IsNumericFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsNumericFunctionTypeSpecifyingExtension;
	}


	public function createService0221(): PHPStan\Type\Php\IsScalarFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsScalarFunctionTypeSpecifyingExtension;
	}


	public function createService0222(): PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension;
	}


	public function createService0223(): PHPStan\Type\Php\ArrayIsListFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ArrayIsListFunctionTypeSpecifyingExtension;
	}


	public function createService0224(): PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0225(): PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension
	{
	...
	public function createService0226(): PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension
	{
	...
	public function createService0228(): PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension;
	}


	public function createService0229(): PHPStan\Type\Php\StrTokFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrTokFunctionReturnTypeExtension;
	}


	public function createService0230(): PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension;
	}


	public function createService0231(): PHPStan\Type\Php\StrvalFamilyFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrvalFamilyFunctionReturnTypeExtension;
	}


	public function createService0232(): PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension;
	}


	public function createService0233(): PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension
	{
	...
	public function createService0239(): PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory
	{
		return new PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory(
			...
			$this->parameters['analysedPathsFromConfig'],
			$this->parameters['singleReflectionFile'],
			['#^PhpParser\\\#', '#^PHPStan\\\#', '#^Hoa\\\#', '#^Symfony\\\Polyfill\\\Php80\\\#', '#^Composer\\\#']
		);
	}


	public function createService0240(): PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory
	{
	...
	public function createService0241(): PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber
	{
		return new PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber($this->getService('php8PhpParser'));
	}


	public function createService0242(): PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber
	{
		return new PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber;
	}


	public function createService0243(): PHPStan\Rules\Classes\ExistingClassInClassExtendsRule
	{
	...
	public function createService0244(): PHPStan\Rules\Classes\ExistingClassInInstanceOfRule
	{
	...
	public function createService0245(): PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule
	{
	...
	public function createService0246(): PHPStan\Rules\Functions\CallToNonExistentFunctionRule
	{
		return new PHPStan\Rules\Functions\CallToNonExistentFunctionRule($this->getService('reflectionProvider'), false);
	}


	public function createService0247(): PHPStan\Rules\Constants\OverridingConstantRule
	{
		return new PHPStan\Rules\Constants\OverridingConstantRule(true);
	}


	public function createService0248(): PHPStan\Rules\Methods\OverridingMethodRule
	{
		return new PHPStan\Rules\Methods\OverridingMethodRule($this->getService('07'), $this->getService('0103'), true);
	}


	public function createService0249(): PHPStan\Rules\Missing\MissingReturnRule
	{
		return new PHPStan\Rules\Missing\MissingReturnRule(false, true);
	}


	public function createService0250(): PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule
	{
	...
	public function createService0251(): PHPStan\Rules\Namespaces\ExistingNamesInUseRule
	{
	...
	public function createService0252(): PHPStan\Rules\Operators\InvalidIncDecOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidIncDecOperationRule(false);
	}


	public function createService0253(): PHPStan\Rules\Properties\AccessPropertiesRule
	{
	...
	public function createService0254(): PHPStan\Rules\Properties\AccessStaticPropertiesRule
	{
	...
	public function createService0255(): PHPStan\Rules\Properties\ExistingClassesInPropertiesRule
	{
	...
	public function createService0256(): PHPStan\Rules\Functions\FunctionCallableRule
	{
	...
	public function createService0257(): PHPStan\Rules\Properties\OverridingPropertyRule
	{
		return new PHPStan\Rules\Properties\OverridingPropertyRule(true, false);
	}


	public function createService0258(): PHPStan\Rules\Properties\UninitializedPropertyRule
	{
		return new PHPStan\Rules\Properties\UninitializedPropertyRule($this->getService('0108'), []);
	}


	public function createService0259(): PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule
	{
	...
	public function createService0260(): PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule
	{
	...
	public function createService0261(): PHPStan\Rules\Variables\CompactVariablesRule
	{
		return new PHPStan\Rules\Variables\CompactVariablesRule(true);
	}


	public function createService0262(): PHPStan\Rules\Variables\DefinedVariableRule
	{
		return new PHPStan\Rules\Variables\DefinedVariableRule(true, true);
	}


	public function createService0263(): PHPStan\Rules\Regexp\RegularExpressionPatternRule
	{
		return new PHPStan\Rules\Regexp\RegularExpressionPatternRule;
	}


	public function createService0264(): PHPStan\Rules\Classes\LocalTypeAliasesRule
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesRule([], $this->getService('reflectionProvider'), $this->getService('018'));
	}


	public function createService0265(): PHPStan\Rules\Classes\MixinRule
	{
	...
	public function createService0266(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('092'), $this->getService('0112'), true);
	}


	public function createService0267(): PHPStan\Rules\Generics\ClassAncestorsRule
	{
	...
	public function createService0268(): PHPStan\Rules\Generics\InterfaceAncestorsRule
	{
	...
	public function createService0269(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0270(): PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule
	{
		return new PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule($this->getService('0110'), true);
	}


	public function createService0271(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule(true);
	}


	public function createService0272(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0273(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0112'), $this->getService('081'), true);
	}


	public function createService0274(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0275(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0276(): PHPStan\Rules\Functions\ReturnTypeRule
	{
	...
	public function createService0277(): PHPStan\Rules\Generators\YieldFromTypeRule
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0112'), true);
	}


	public function createService0278(): PHPStan\Rules\Generators\YieldInGeneratorRule
	{
		return new PHPStan\Rules\Generators\YieldInGeneratorRule(true);
	}


	public function createService0279(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(false, true);
	}


	public function createService0280(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('083'), true);
	}


	public function createService0281(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('083'), true);
	}


	public function createService0282(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('083'), true);
	}


	public function createService0283(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule($this->getService('0108'), [], [], false);
	}


	public function createService0284(): PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('083'), true);
	}


	public function createService0285(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('083'), true);
	}


	public function createService0286(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('083'), true);
	}


	public function createService0287(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('084'), false, true);
	}


	public function createService0288(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('084'), false, true);
	}


	public function createService0289(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('084'), false, true);
	}


	public function createService0290(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule(false);
	}


	public function createService0291(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule(false);
	}


	public function createService0292(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('083'), true);
	}


	public function createService0293(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('083'), true);
	}


	public function createService0294(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('083'), true);
	}


	public function createService0295(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('083'), true);
	}


	public function createService0296(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('083'), true);
	}


	public function createService0297(): PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule(false);
	}


	public function createService0298(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
	...
	{
		return $this->getService('0239')->create();
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/home/kieron/Projects/thumper/tmp/cache/PHPStan');
	}


	public function createServiceContainer(): Container_b0532d912a
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/home/kieron/Projects/thumper');
	}
	...
	public function createServiceRules__100(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('094'));
	}


	public function createServiceRules__101(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0112'));
	}


	public function createServiceRules__102(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('094'));
	}


	public function createServiceRules__103(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule($this->getService('0112'));
	}


	public function createServiceRules__104(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
	...
	public function createServiceRules__105(): PHPStan\Rules\Variables\ThrowTypeRule
	{
		return new PHPStan\Rules\Variables\ThrowTypeRule($this->getService('0112'));
	}


	public function createServiceRules__106(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0112'));
	}


	public function createServiceRules__107(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__108(): PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule;
	}


	public function createServiceRules__109(): PHPStan\Rules\DeadCode\NoopRule
	{
	...
	public function createServiceRules__110(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
		return new PHPStan\Rules\DeadCode\UnreachableStatementRule;
	}


	public function createServiceRules__111(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0106'));
	}


	public function createServiceRules__112(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule;
	}


	public function createServiceRules__113(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
		return new PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule;
	}


	public function createServiceRules__114(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createServiceRules__115(): PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__116(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__117(): PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule($this->getService('0112'));
	}


	public function createServiceRules__118(): PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule
	{
	...
	public function createServiceRules__119(): PHPStan\Rules\Methods\NullsafeMethodCallRule
	{
	...
	public function createServiceRules__120(): PHPStan\Rules\Properties\NullsafePropertyFetchRule
	{
		return new PHPStan\Rules\Properties\NullsafePropertyFetchRule;
	}


	public function createServiceRules__121(): PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule;
	}


	public function createServiceRules__122(): PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule;
	}


	public function createServiceRules__123(): PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule;
	}


	public function createServiceRules__124(): PHPStan\Rules\DateTimeInstantiationRule
	{
		return new PHPStan\Rules\DateTimeInstantiationRule;
	}


	public function createServiceRules__125(): PHPStan\Rules\Functions\ImplodeFunctionRule
	{
		return new PHPStan\Rules\Functions\ImplodeFunctionRule($this->getService('reflectionProvider'), $this->getService('0112'));
	}


	public function createServiceRules__126(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__127(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__128(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__129(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
	...
	public function createServiceRules__130(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__131(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
	...
	public function createServiceRules__18(): PHPStan\Rules\Classes\ExistingClassesInClassImplementsRule
	{
	...
	public function createServiceRules__19(): PHPStan\Rules\Classes\ExistingClassesInInterfaceExtendsRule
	{
	...
	public function createServiceRules__20(): PHPStan\Rules\Classes\ExistingClassInTraitUseRule
	{
		return new PHPStan\Rules\Classes\ExistingClassInTraitUseRule($this->getService('082'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__21(): PHPStan\Rules\Classes\InstantiationRule
	{
	...
	public function createServiceRules__22(): PHPStan\Rules\Classes\InstantiationCallableRule
	{
		return new PHPStan\Rules\Classes\InstantiationCallableRule;
	}


	public function createServiceRules__23(): PHPStan\Rules\Classes\InvalidPromotedPropertiesRule
	{
		return new PHPStan\Rules\Classes\InvalidPromotedPropertiesRule($this->getService('07'));
	}


	public function createServiceRules__24(): PHPStan\Rules\Classes\NewStaticRule
	{
		return new PHPStan\Rules\Classes\NewStaticRule;
	}


	public function createServiceRules__25(): PHPStan\Rules\Classes\NonClassAttributeClassRule
	{
		return new PHPStan\Rules\Classes\NonClassAttributeClassRule;
	}


	public function createServiceRules__26(): PHPStan\Rules\Classes\TraitAttributeClassRule
	{
		return new PHPStan\Rules\Classes\TraitAttributeClassRule;
	}


	public function createServiceRules__27(): PHPStan\Rules\Constants\FinalConstantRule
	{
		return new PHPStan\Rules\Constants\FinalConstantRule($this->getService('07'));
	}


	public function createServiceRules__28(): PHPStan\Rules\Exceptions\ThrowExpressionRule
	{
		return new PHPStan\Rules\Exceptions\ThrowExpressionRule($this->getService('07'));
	}


	public function createServiceRules__29(): PHPStan\Rules\Functions\ArrowFunctionAttributesRule
	{
	...
	public function createServiceRules__30(): PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule($this->getService('0105'));
	}


	public function createServiceRules__31(): PHPStan\Rules\Functions\CallToFunctionParametersRule
	{
	...
	public function createServiceRules__32(): PHPStan\Rules\Functions\ClosureAttributesRule
	{
		return new PHPStan\Rules\Functions\ClosureAttributesRule($this->getService('080'));
	}


	public function createServiceRules__33(): PHPStan\Rules\Functions\DefineParametersRule
	{
		return new PHPStan\Rules\Functions\DefineParametersRule($this->getService('07'));
	}


	public function createServiceRules__34(): PHPStan\Rules\Functions\ExistingClassesInArrowFunctionTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInArrowFunctionTypehintsRule($this->getService('093'));
	}


	public function createServiceRules__35(): PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule($this->getService('093'));
	}


	public function createServiceRules__36(): PHPStan\Rules\Functions\ExistingClassesInTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInTypehintsRule($this->getService('093'));
	}


	public function createServiceRules__37(): PHPStan\Rules\Functions\FunctionAttributesRule
	{
		return new PHPStan\Rules\Functions\FunctionAttributesRule($this->getService('080'));
	}


	public function createServiceRules__38(): PHPStan\Rules\Functions\InnerFunctionRule
	{
		return new PHPStan\Rules\Functions\InnerFunctionRule;
	}


	public function createServiceRules__39(): PHPStan\Rules\Functions\ParamAttributesRule
	{
	...
	public function createServiceRules__40(): PHPStan\Rules\Functions\PrintfParametersRule
	{
		return new PHPStan\Rules\Functions\PrintfParametersRule($this->getService('07'));
	}


	public function createServiceRules__41(): PHPStan\Rules\Functions\ReturnNullsafeByRefRule
	{
		return new PHPStan\Rules\Functions\ReturnNullsafeByRefRule($this->getService('0105'));
	}


	public function createServiceRules__42(): PHPStan\Rules\Keywords\ContinueBreakInLoopRule
	{
		return new PHPStan\Rules\Keywords\ContinueBreakInLoopRule;
	}


	public function createServiceRules__43(): PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule
	{
		return new PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule;
	}


	public function createServiceRules__44(): PHPStan\Rules\Methods\CallMethodsRule
	{
		return new PHPStan\Rules\Methods\CallMethodsRule($this->getService('0101'), $this->getService('092'));
	}


	public function createServiceRules__45(): PHPStan\Rules\Methods\CallStaticMethodsRule
	{
		return new PHPStan\Rules\Methods\CallStaticMethodsRule($this->getService('0102'), $this->getService('092'));
	}


	public function createServiceRules__46(): PHPStan\Rules\Methods\ExistingClassesInTypehintsRule
	{
		return new PHPStan\Rules\Methods\ExistingClassesInTypehintsRule($this->getService('093'));
	}


	public function createServiceRules__47(): PHPStan\Rules\Methods\MethodCallableRule
	{
		return new PHPStan\Rules\Methods\MethodCallableRule($this->getService('0101'), $this->getService('07'));
	}


	public function createServiceRules__48(): PHPStan\Rules\Methods\MissingMethodImplementationRule
	{
		return new PHPStan\Rules\Methods\MissingMethodImplementationRule;
	}


	public function createServiceRules__49(): PHPStan\Rules\Methods\MethodAttributesRule
	{
	...
	public function createServiceRules__50(): PHPStan\Rules\Methods\StaticMethodCallableRule
	{
		return new PHPStan\Rules\Methods\StaticMethodCallableRule($this->getService('0102'), $this->getService('07'));
	}


	public function createServiceRules__51(): PHPStan\Rules\Operators\InvalidAssignVarRule
	{
		return new PHPStan\Rules\Operators\InvalidAssignVarRule($this->getService('0105'));
	}


	public function createServiceRules__52(): PHPStan\Rules\Properties\AccessPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessPropertiesInAssignRule($this->getService('0253'));
	}


	public function createServiceRules__53(): PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule($this->getService('0254'));
	}


	public function createServiceRules__54(): PHPStan\Rules\Properties\PropertyAttributesRule
	{
		return new PHPStan\Rules\Properties\PropertyAttributesRule($this->getService('080'));
	}


	public function createServiceRules__55(): PHPStan\Rules\Properties\ReadOnlyPropertyRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyRule($this->getService('07'));
	}


	public function createServiceRules__56(): PHPStan\Rules\Variables\UnsetRule
	{
		return new PHPStan\Rules\Variables\UnsetRule;
	}


	public function createServiceRules__57(): PHPStan\Rules\Whitespace\FileWhitespaceRule
	{
		return new PHPStan\Rules\Whitespace\FileWhitespaceRule;
	}


	public function createServiceRules__58(): PHPStan\Rules\Classes\UnusedConstructorParametersRule
	{
		return new PHPStan\Rules\Classes\UnusedConstructorParametersRule($this->getService('0113'));
	}


	public function createServiceRules__59(): PHPStan\Rules\Constants\ConstantRule
	{
	...
	public function createServiceRules__60(): PHPStan\Rules\Functions\UnusedClosureUsesRule
	{
		return new PHPStan\Rules\Functions\UnusedClosureUsesRule($this->getService('0113'));
	}


	public function createServiceRules__61(): PHPStan\Rules\Variables\EmptyRule
	{
		return new PHPStan\Rules\Variables\EmptyRule($this->getService('0100'));
	}


	public function createServiceRules__62(): PHPStan\Rules\Variables\IssetRule
	{
		return new PHPStan\Rules\Variables\IssetRule($this->getService('0100'));
	}


	public function createServiceRules__63(): PHPStan\Rules\Variables\NullCoalesceRule
	{
		return new PHPStan\Rules\Variables\NullCoalesceRule($this->getService('0100'));
	}


	public function createServiceRules__64(): PHPStan\Rules\Cast\EchoRule
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0112'));
	}


	public function createServiceRules__65(): PHPStan\Rules\Cast\InvalidCastRule
	{
		return new PHPStan\Rules\Cast\InvalidCastRule($this->getService('reflectionProvider'), $this->getService('0112'));
	}


	public function createServiceRules__66(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('05'), $this->getService('0112'));
	}


	public function createServiceRules__67(): PHPStan\Rules\Cast\PrintRule
	{
		return new PHPStan\Rules\Cast\PrintRule($this->getService('0112'));
	}


	public function createServiceRules__68(): PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule
	{
		return new PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule;
	}


	public function createServiceRules__69(): PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule
	{
	...
	public function createServiceRules__70(): PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__71(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('098'));
	}


	public function createServiceRules__72(): PHPStan\Rules\Generics\FunctionTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0114'), $this->getService('098'));
	}


	public function createServiceRules__73(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('099'));
	}


	public function createServiceRules__74(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0114'), $this->getService('098'));
	}


	public function createServiceRules__75(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0114'), $this->getService('098'));
	}


	public function createServiceRules__76(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('099'));
	}


	public function createServiceRules__77(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0114'), $this->getService('098'));
	}


	public function createServiceRules__78(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0114'), $this->getService('096'));
	}


	public function createServiceRules__79(): PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule
	{
	...
	public function createServiceRules__80(): PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__81(): PHPStan\Rules\Operators\InvalidBinaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('05'), $this->getService('0112'));
	}


	public function createServiceRules__82(): PHPStan\Rules\Operators\InvalidUnaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidUnaryOperationRule;
	}


	public function createServiceRules__83(): PHPStan\Rules\Operators\InvalidComparisonOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0112'));
	}


	public function createServiceRules__84(): PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('097'), $this->getService('0107'));
	}


	public function createServiceRules__85(): PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule
	{
	...
	public function createServiceRules__86(): PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule($this->getService('097'), $this->getService('0107'));
	}


	public function createServiceRules__87(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('010'), $this->getService('013'));
	}


	public function createServiceRules__88(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('010'), $this->getService('013'));
	}


	public function createServiceRules__89(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
	...
	public function createServiceRules__90(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0114'));
	}


	public function createServiceRules__91(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createServiceRules__92(): PHPStan\Rules\Arrays\AppendedArrayItemTypeRule
	{
		return new PHPStan\Rules\Arrays\AppendedArrayItemTypeRule($this->getService('0110'), $this->getService('0112'));
	}


	public function createServiceRules__93(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0112'), $this->getService('081'));
	}


	public function createServiceRules__94(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0112'));
	}


	public function createServiceRules__95(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0112'));
	}


	public function createServiceRules__96(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0112'));
	}


	public function createServiceRules__97(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0112'));
	}


	public function createServiceRules__98(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0112'));
	}


	public function createServiceRules__99(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/home/kieron/Projects/thumper');
	}
